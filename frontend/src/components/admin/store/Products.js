...
import {Image, Form, Input, Select, Button, Alert, message} from 'antd';
            ...
            <div className='row mx-0 px-0'>
                <div className='col-lg-4 mx-0 px-0'>
                    ...
                    <div className='row mx-0 px-0 my-2'>
                        <ImagePreview
                            image={productDetails.images && productDetails.images[0] && !image ? productDetails.images[0] : image}/>
                    </div>
                        ...
                        <div className='row mx-0 px-2'>
                            {
                                productDetails.images ? productDetails.images.map(image =>
                                        <div className='col-md-3 border rounded'
                                             style={{width: '103px', height: '103px', margin: '4px'}}>
                                            <CloseOutlined
                                                style={{position: 'absolute', marginTop: '10px', cursor: "pointer"}}
                                                onClick={() => {
                                                    setImage('');
                            ...
                            <div className='col-md-3 border rounded hove image-upload'
                                 style={{width: '103px', height: '103px', margin: '4px', cursor: "pointer"}}
                                 onClick={() => {
