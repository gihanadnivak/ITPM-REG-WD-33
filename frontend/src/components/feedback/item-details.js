        ...
        <div className="container container-md">
            ...
            <div className="row">
                ...
                <div className="col-md-4 mx-0 p-3">
                    <img
                        alt="Product Image" src={images && images[0] ? images[0] : 'https://bulma.io/images/placeholders/256x256.png" className="w-100'}
                ...
                <div className="col-md-8 mx-0 p-3">
                    <table className="table table-striped" style={{fontSize: '16px'}}>
                        ...
                        <tr>
                            ...
                            <td>{available ? available + ' items left' : (
                                <span className="text-danger">Out of stock.</span>)}</td>
                        </tr>
                        <tr>
                    ...
                    <div className="row">
                        <div className="col-md-7">
                            ...
                            <Button className="mx-3" shape="circle" icon={<MinusOutlined/>} size="small"
                                    disabled={amount <= 1} onClick={() => setAmount(amount - 1)}/>
                            <span className="fw-bold">{amount}</span>
                            <Button className="mx-3" shape="circle" icon={<PlusOutlined/>} size="small"
                                    disabled={amount >= available} onClick={() => setAmount(amount + 1)}/>
                            <Link type='button' to='/payment' className="btn btn-primary m-1"
                                  onClick={handleBuy}>Buy Now</Link>
                            <Link type='button' to='/orders' className="btn btn-secondary m-1"
                                  onClick={handleOrder}>Order</Link>
                        </div>
